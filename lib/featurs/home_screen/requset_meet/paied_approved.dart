...
class AprrovedRequst extends StatelessWidget {
  const AprrovedRequst({super.key});
          ...
          return state is GetRequestsLoading
              ...
              : cubit.payAprrovedList.isEmpty
                  ...
                  : SingleChildScrollView(
                      child: Column(
                        children: [
                          for (int i = 0; i < cubit.payAprrovedList.length; i++)
                            RequestCard(
                              index: i,
                              model: cubit.payAprrovedList[i],
                            ),
                        ],
                      ),
                    );
