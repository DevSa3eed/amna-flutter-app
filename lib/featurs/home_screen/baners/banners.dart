    ...
    return BlocProvider(
      ...
      child: BlocConsumer<BannersCubit, BannersState>(
        ...
        builder: (context, state) {
          ...
          return cubit.listOfBanners!.isEmpty
              ? Container(
              ...
              : Container(
                  ...
                  child: CarouselSlider(
                    items: [
                      for (int i = 0; i < cubit.listOfBanners!.length; i++)
                        ConditionBuilder(
...
class OneBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<BannersCubit, BannersState>(
      listener: (context, state) {
        if (state is DeleteBannerSuccessful || state is EditBannerSuccessful) {
          // // context.read<BannersCubit>().getAllBanners()
          // Navigator.pushNamed(context, Routes.homeRoute);
        }
      },
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            CircleAvatar(
                              ...
                              child: IconButton(
                                  onPressed: () {
                                    context.read<BannersCubit>().DeleteBanner(
